...
- Family Involvement
    - Distribution had an left-skewed overall. When looking borough-specific, the distributions appeared more normal. I feel confident using borough averages to impute the few missing rows.

- School Attendance
    - Overall distribution appeared normal. Borough-specific distributions were largely affected by outliers (particularly Queens & Staten Island). I feel more confident using overall averages to impute missing rows.
...
The results of the T-Test tell us that the average percent of positive family involvement is statistically significantly less than the average percent of student attendance.

</div>

***

## **Some Notes from Jelly (to edit later)**

> !NOTE
> Histogram for school attendance and family involvement. Get the distribution of these columns before testing (As another means of justifying reason for imputing with borough/overall averages).


> !NOTE
> School size thresholds, (adjustable? for the stakeholder to determine what an appropriate threshold is, or if it's on us to make that determination. We'll have to justify it properly).
